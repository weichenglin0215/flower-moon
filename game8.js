(function () {
    const Game8 = {
        ...
        difficultySettings: {
            '小學': { timeLimitRate: 1.5, poemMinRating: 6, maxMistakeCount: 6, hints: 'all', splitPath: true, obstacles: 0, decoyPool: 'normal', minLines: 2, minChars: 8, maxChars: 14, maxLines: 10 },
            '中學': { timeLimitRate: 1.2, poemMinRating: 5, maxMistakeCount: 5, hints: 'startEnd', splitPath: true, obstacles: 0, decoyPool: 'normal', minLines: 4, minChars: 20, maxChars: 28, maxLines: 10 },
