(function () {
    const Game8 = {
        ...
        difficultySettings: {
            '小學': { timeLimitRate: 1.5, poemMinRating: 6, maxMistakeCount: 6, hints: 'all', splitPath: true, obstacles: 0, decoyPool: 'normal', minLines: 2, maxLines: 2, minChars: 8, maxChars: 14 },
            '中學': { timeLimitRate: 1.2, poemMinRating: 5, maxMistakeCount: 5, hints: 'startEnd', splitPath: true, obstacles: 0, decoyPool: 'normal', minLines: 4, maxLines: 10, minChars: 20, maxChars: 28 },
            '高中': { timeLimitRate: 1, poemMinRating: 4, maxMistakeCount: 4, hints: 'startEnd', splitPath: true, obstacles: 0, decoyPool: 'normal', minLines: 4, maxLines: 10, minChars: 20, maxChars: 56 },
            '大學': { timeLimitRate: 1.5, poemMinRating: 3, maxMistakeCount: 3, hints: 'start', splitPath: false, obstacles: 0, decoyPool: 'normal', minLines: 4, maxLines: 10, minChars: 20, maxChars: 56 },
            '研究所': { timeLimitRate: 2, poemMinRating: 3, maxMistakeCount: 3, hints: 'start', splitPath: false, obstacles: 0, decoyPool: 'hard', minLines: 4, maxLines: 10, minChars: 20, maxChars: 56 }
        },
