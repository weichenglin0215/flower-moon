    ...
    const Game31 = {
        ...
        */
        ...
        gameOver: function (win, reason) {
            ...
            window.FMGame.gameOver(this, win, reason || '詩眼難辨！', {
                gameNo: 31,
                gameKey: 'game31',
                anim: {
                ...
                setButtons: (win) => {
                    document.getElementById('game31-retryGame-btn').disabled = win;
                    document.getElementById('game31-newGame-btn').disabled = win;
                }
            });
        }
    };
