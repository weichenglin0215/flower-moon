...
(function () {
    ...
    const Game17 = {
        ...
        updateUIForMode: function () {
            ...
            if (this.isLevelMode) {
                if (tag) { tag.textContent = `${window.FMRoundLabel(this.currentLevelIndex)}`; tag.style.backgroundColor = colors[this.difficulty] || '#4CAF50'; tag.style.color = this.difficulty === '研究所' ? '#333' : '#fff'; tag.dataset.level = this.difficulty; }
        ...
        gameOver: function (win, reason) {
            ...
            window.FMGame.gameOver(this, win, reason === 'timeout' ? '時間到！' : '詩心未竟！', {
                gameNo: 17,
                gameKey: 'game17',
                anim: {
                ...
                setButtons: (win) => {
                    document.getElementById('game17-retryGame-btn').disabled = win;
                    document.getElementById('game17-newGame-btn').disabled = win;
