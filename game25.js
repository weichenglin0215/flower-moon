...
(function () {
    const Game25 = {
        ...
        gameOver: function (win, reason) {
            ...
            window.FMGame.gameOver(this, win, reason || '珠散字落！', {
                gameNo: 25,
                gameKey: 'game25',
                anim: {
                ...
                setButtons: (win) => {
                    document.getElementById('game25-retryGame-btn').disabled = win;
                    document.getElementById('game25-newGame-btn').disabled = win;
                }
            });
        }
    };
