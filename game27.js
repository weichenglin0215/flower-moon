...
(function () {
    const Game27 = {
        ...
        gameOver: function (win, reason) {
            ...
            window.FMGame.gameOver(this, win, reason || '塔已壘崩！', {
                gameNo: 27,
                gameKey: 'game27',
                anim: {
                ...
                setButtons: (win) => {
                    document.getElementById('game27-retryGame-btn').disabled = win;
                    document.getElementById('game27-newGame-btn').disabled = win;
                }
            });
        }
    };
